...
from sqlalchemy import String, Text, ForeignKey, Enum as SAEnum, JSON, Numeric
...
class StudentDecision(Base, UUIDMixin, TimestampMixin):
    ...
    decision_data: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict, server_default="{}")
